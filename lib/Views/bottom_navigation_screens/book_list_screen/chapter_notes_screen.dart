...
import 'package:bible_app/Controllers/Cubits/chapter_notes_cubit/chapter_notes_cubit.dart';
...
class _ChapterNotesScreenState extends State<ChapterNotesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: BlocBuilder<ChapterNotesCubit, ChapterNotesState>(
  builder: (context, state) {
    if(state is ChapterNotesLoaded){
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: BlocBuilder<ChapterNotesCubit, ChapterNotesState>(
              builder: (context, state) {
               if(state is ChapterNotesLoaded){
               ...
               }else if(state is ChapterNotesLoading){
                 
                 return Center(child: CircularProgressIndicator(),);
               }else if(state is ChapterNotesError){
